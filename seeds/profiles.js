  ...
  return knex('profiles').del()
    .then(function () {
      ...
      return knex('profiles').insert([
        ...
        {id: 27, user_id: 99927, url: 'http://www.ilovenature.world/i-love-nature-news/2018/8/11/400-year-old-shark-found-in-the-arctic-may-be-the-oldest-living-vertebrate-alive', profile_image: 'https://en.wikipedia.org/wiki/Greenland_shark#/media/File:Somniosus_microcephalus_okeanos.jpg'}
      ])
    })
};